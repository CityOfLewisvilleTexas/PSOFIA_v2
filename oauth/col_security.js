...
//alert('apps - col security');
    ...
    if (window.location.host === 'apps') {
        ...
        if (window.location.href.split('://')[1].split('.')[0].toLowerCase() !== 'apps') {
            ...
            oauthRedirectUrl = 'https://' + window.location.href.split('://')[1].split('.')[0].toLowerCase() + '.cityoflewisville.com/oauth/index.html';
        } else {
...
;(function() {   
    if (window.location.host === 'apps') {
        ...
        if (window.location.href.split('://')[1].split('.')[0].toLowerCase() !== 'apps') {
            apiUrl = 'https://query.cityoflewisville.com/';
            oauthRedirectUrl = window.location.protocol + '//' + window.location.href.split('://')[1].split('.')[0].toLowerCase() + '.cityoflewisville.com/oauth/index.html'
        } else {
            apiUrl = 'https://ax1vnode1.cityoflewisville.com/';
            oauthRedirectUrl = window.location.protocol + '//' + window.location.href.split('://')[1].split('.')[0].toLowerCase() + '.cityoflewisville.com/oauth/index.html'
        }
